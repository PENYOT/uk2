...
include '../../../config/backend_guard.php';
...
<head>
  ...
  <title>UK 2 | PEMBAYARAN LISTRIK BACKEND</title>

  <meta name="description" content="" />

  <!-- Favicon -->
  <link rel="icon" type="image/x-icon" href="../../../storages/1.png" />
...
<body>
  <!-- Layout wrapper (dibuka di sini, ditutup di footer.php) -->
